...
class Config {
    companion object {
        ...
        val DELETE_LEDGER_TITLE = "Deleting ledger"
        ...
        val DELETE_LEDGER_MESSAGE = "Do you want to delete the ledger?"
        val INVOICE_SETTINGS_FAILED_MESSAGE = "Invoice settings is incomplete"
        val YES_MESSAGE = "Yes"
        val NO_MESSAGE = "No"
        val RUPEE_SIGN = "₹"
        val CTS = "cts"
        ...
        val TOOLBAR_TITLE_BOUGHT_PRODUCT = "Bought product"
        ...
        val TOOLBAR_TITLE_ADD_SELLER_LEDGER = "Add seller ledger"
